...
class AirGapMonitorApp:
    ...
    def initialiseUI(self):
        ...
        self.fetch_button = tk.Button(frame1, text="Fetch Data", command=self.fetchData)
        ...
        tree.pack()
        next_button = tk.Button(frame2, text="Start Pre-Hold", command=self.startThirdPageTimer)
        next_button.pack()
        ...
        next_button = tk.Button(frame3, text="Next Hold", command=lambda: self.showFrame("thirdPage"))
        next_button.grid(row=8, column=0, sticky="W")

        self.updateDifference()

    def startThirdPageTimer(self):
        self.showFrame("thirdPage")
        self.startTimer(60 * 60)  # Start the timer for 60 minutes
    ...
    def updateTimer(self):
        if self.timer_seconds > 0:
            ...
            # After 1 second, call updateTimer again
    ...
    def fetchData(self):
        try:
            ...
            self.showFrame("secondPage")  # Transition to the secondPage after fetching data.
